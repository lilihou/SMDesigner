...
data_fold1=Path('/home/lijuanh/projects/def-jonatp/lijuanh/riboswitch_mu_design/seq_struc_riboswitch')
data_fold2=Path('/home/lijuanh/projects/def-jonatp/lijuanh/riboswitch_mu_design/seq_struc_riboswitch1')
...
for i in finame:
	...
	for line in fi.readlines():
		...
		if '#=GC SS_cons' in line:
			...
			line1=re.sub('[\{\[\(]','<',ls[-1])
			line2=re.sub('[\}\]\)]','>',line1)
			line3=f'{ls_seq:<50}'+re.sub('[\_\-\:\~]','.',line2)+'\n'
			fo.write(line3)
		elif '#=GC cov_SS_cons' in line:
			fo.write(line)
		elif '#=GF NUM_COV' in line:
